    ...
    return this.each(function(){
      ...
      el.find("> img").load(function () {
        ...
        if (settings.autoSlide == true) {
          ...
          // if( autoSlide && !movecontinue){
          //   var $cloneElChild = clone(el.child());
          //   el.append($cloneElChild)
          //   // $bg.css('transition', 'all 700ms ease-out 0s');
          //   // $bg.css('background-position', (-width) +'px 0px');
          // }

          // while(el.css('background-position') == '0% 0%' || el.css('background-position') == '0px 0px' ){
          //   el.css('background-position', (-width) +'px 0px');
          //   return;
          // }
        }  
        var cloneEl = clone(el);
        var node = cloneEl.html();
        
        console.log(cloneEl, node)
        el.append(node)
